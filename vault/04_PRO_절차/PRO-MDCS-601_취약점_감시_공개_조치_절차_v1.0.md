...
| 단계 | PSO | SBOM 관리자 | 개발팀 | QA | 오동석 | RA | CSIRT |
|---|---|---|---|---|---|---|---|
...
| 10 | 공개 시점 조정 | 해결 지연·심각도 고려 시 식약처 협의 | 오동석 + RA | 상황 판단 | 협의 기록 |
...
| 버전 | 일자 | 변경내용 | 승인자 |
|---|---|---|---|
| 1.0 | 2026-04-17 | 최초 제정 (SaMD-CSMS 제20·21·22조 통합, 제10조 업데이트 준수 포함) | 오동석 |
