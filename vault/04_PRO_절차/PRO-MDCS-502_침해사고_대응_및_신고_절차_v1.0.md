...
| 단계 | SecOps | CSIRT | 오동석 | CEO | RA | DPO | 홍보/CS |
|---|---|---|---|---|---|---|---|
| 인지·초기 분석 (1차) | **R** | **A** | I | - | - | I | - |
...
| 3 | 등급 판정 | 경미/중대/위기 분류 | CSIRT + 오동석 | 초기 분석 | 등급 판정서 | 2시간 이내 |
...
| 10 | 재발 방지 수립 | 기술적 강화·프로세스·교육 대책 수립, 식약처·MSP 통보 | CSIRT + 오동석 | 원인 분석 | 재발방지 보고 | 30일 이내 |
