...
| 단계 | 요청자 | 라인매니저 | IAM 관리자 | 시스템 소유자 | 오동석 |
|---|---|---|---|---|---|
| 계정 생성 요청 | **R** | **A** | C | I | - |
| 권한 부여 (RBAC) | - | C | **R** | **A** | I |
| 권한 변경·해지 | **R** | **A** | **R** | C | - |
...
flowchart TD
  ...
  E --> F{원격 접속<br/>필요?}
  F -->|Yes| G[오동석 승인·VPN/SSH<br/>WI-401-04]
  F -->|No| H[사용]
  G --> H
  H --> I[반기 권한 검토]
  I --> J{변경 필요?}
...
| 6 | 원격 접속 심의 | 기본 차단, 필요 시 MFA·IP 제한·허용 시간 명시하여 오동석 승인 | 오동석 | 원격 접속 요청 | 승인 기록 |
...
| 버전 | 일자 | 변경내용 | 승인자 |
|---|---|---|---|
| 1.0 | 2026-04-17 | 최초 제정 (SaMD-CSMS 제05조 기반) | 오동석 |
