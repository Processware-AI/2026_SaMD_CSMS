...
```mermaid
flowchart TD
  A[개정 요청 접수<br/>WI-401-01] --> B{분류<br/>경미/중대}
  B -->|경미| C[QMR 검토]
  B -->|중대| D[영향평가<br/>WI-401-02]
  D --> E[PCB 심의]
  E --> F{결정}
  F -->|승인| G[CEO 최종 승인]
  F -->|반려| R[요청자 피드백]
  C -->|승인| H[반영<br/>WI-401-04]
  G --> H
  C -->|반려| R
  H --> I[배포 공지]
  I --> J[MAT-001 기록]
...
## 6. 연계 업무지침 (WI)
- [[WI-401-01_개정요청_접수]] — 요청 접수·분류
- [[WI-401-02_영향평가]] — 파급 분석
- [[GS-WI-401-04_개정_및_버전관리]] — 반영·배포 (실무 상세)
